...
\begin{cventries}
    ...
    \cventry
        ...
        {
        \begin{cvitems}
            \item {\textbf{A Level}, 2011--12 --- \entrydatestyle{Biology (A*), Mathematics (A*), Physics (B), Chemistry (AS Level) (B)}}
            \vpaddingEdu
            %\item {\textbf{Open University}, 2012 --- \entrydatestyle{Introducing Astronomy (10 credit course)}}
            %\vpaddingEdu
            \item {\textbf{GCSE}, 2010 --- \entrydatestyle{10 including English Language and Mathematics at grades A* (4) to A (6)}}
            %\vpaddingEdu
