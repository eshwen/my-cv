...
\begin{cventries}
    \cventry
        ...
        \begin{cvitems} % Description(s) bullet points
            \item {Thesis: \textbf{Searches for dark matter with a focus on invisibly decaying Higgs bosons using the full Run-2 dataset of the CMS experiment at the LHC} --- \entrydatestyle{Under supervision of H. Fl\"{a}cher. Submitted December 2020}}
            \vpaddingEduSubpoint
