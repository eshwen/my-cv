...
\begin{cventries}
    ...
    {
      \begin{cvitems}
        \item {Primary focus of my PhD concerned statistical analysis of multi-terabyte datasets collected by the CMS experiment from the Large Hadron Collider.}
        ...
        \item {Visualisation with matplotlib, plotly. Formal presentations of results with LaTeX, PowerPoint, Jupyter Notebooks.}
        \end{cvitems}
    }
    ...
    {}
    {
      \begin{cvitems}
        \item {Principal component of any physics degree. As an undergraduate, conducted more traditional pen-and-paper problem solving in many topics. As a PhD student, wrote code to solve physics problems numerically and perform data analysis for high energy particle physics.}
          \item{In industry, developing advanced data-driven solutions to complex business problems. Leveraging high-performance programming.}
        \end{cvitems}
    }
