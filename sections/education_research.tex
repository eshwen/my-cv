    ...
    \cventry
        ...
        \begin{cvitems} % Description(s) bullet points
            ...
            \begin{itemize}[itemsep=\vPaddingLength, label=\bullet]
                ...
                \item{Executed comprehensive \textbf{statistical analysis} on real and simulated data, meticulously documenting results and code.}
                \item{Leveraging modern data science tools, vectorisation, and \textbf{distributed computing} to process multiple terabytes of data.}
